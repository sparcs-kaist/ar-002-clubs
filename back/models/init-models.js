...
function initModels(sequelize) {
  ...
  var ActivityFeedbackExecutive = _ActivityFeedbackExecutive(sequelize, DataTypes);
  ...
  var FundingFixtureObjectType = _FundingFixtureObjectType(sequelize, DataTypes);
  ...
  var FundingTransportationMember = _FundingTransportationMember(sequelize, DataTypes);
  var FundingTransportationType = _FundingTransportationType(sequelize, DataTypes);
  ...
  var RegistrationActivityEvidence = _RegistrationActivityEvidence(sequelize, DataTypes);
  var RegistrationActivityFeedback = _RegistrationActivityFeedback(sequelize, DataTypes);
  ...
  Club.belongsToMany(Semester, { as: 'semester_id_Semesters', through: ActivitySign, foreignKey: "club_id", otherKey: "semester_id" });
  ...
  Funding.belongsToMany(Member, { as: 'student_id_Members', through: FundingTransportationMember, foreignKey: "funding_id", otherKey: "student_id" });
  Member.belongsToMany(Funding, { as: 'funding_id_Fundings', through: FundingTransportationMember, foreignKey: "student_id", otherKey: "funding_id" });
  Member.belongsToMany(RegistrationActivity, { as: 'activity_id_RegistrationActivities', through: RegistrationActivityMember, foreignKey: "member_student_id", otherKey: "activity_id" });
  Member.belongsToMany(Semester, { as: 'semester_id_Semester_MemberStatuses', through: MemberStatus, foreignKey: "student_id", otherKey: "semester_id" });
  RegistrationActivity.belongsToMany(Member, { as: 'member_student_id_Members', through: RegistrationActivityMember, foreignKey: "activity_id", otherKey: "member_student_id" });
  Semester.belongsToMany(Club, { as: 'club_id_Clubs', through: ActivitySign, foreignKey: "semester_id", otherKey: "club_id" });
  Semester.belongsToMany(Club, { as: 'club_id_Club_SemesterClubs', through: SemesterClub, foreignKey: "semester_id", otherKey: "club_id" });
  Semester.belongsToMany(Member, { as: 'student_id_Member_MemberStatuses', through: MemberStatus, foreignKey: "semester_id", otherKey: "student_id" });
  ActivityFeedback.belongsTo(Activity, { as: "activity_Activity", foreignKey: "activity"});
  Activity.hasMany(ActivityFeedback, { as: "ActivityFeedbacks", foreignKey: "activity"});
  ActivityFeedbackExecutive.belongsTo(Activity, { as: "activity_Activity", foreignKey: "activity"});
  Activity.hasOne(ActivityFeedbackExecutive, { as: "ActivityFeedbackExecutive", foreignKey: "activity"});
  ...
  Activity_init.belongsTo(ActivityType, { as: "activity_type", foreignKey: "activity_type_id"});
  ActivityType.hasMany(Activity_init, { as: "Activity_inits", foreignKey: "activity_type_id"});
  RegistrationActivity.belongsTo(ActivityType, { as: "activity_type", foreignKey: "activity_type_id"});
  ActivityType.hasMany(RegistrationActivity, { as: "RegistrationActivities", foreignKey: "activity_type_id"});
  ...
  Club.hasMany(RegistrationActivity, { as: "RegistrationActivities", foreignKey: "club_id"});
  ...
  Registration.belongsTo(Division, { as: "division_Division", foreignKey: "division"});
  Division.hasMany(Registration, { as: "Registrations", foreignKey: "division"});
  ...
  ExecutiveMember.belongsTo(ExecutiveBureau, { as: "main_bureau_ExecutiveBureau", foreignKey: "main_bureau"});
  ExecutiveBureau.hasMany(ExecutiveMember, { as: "ExecutiveMembers", foreignKey: "main_bureau"});
  ExecutiveMember.belongsTo(ExecutiveBureau, { as: "sub_bureau_ExecutiveBureau", foreignKey: "sub_bureau"});
  ExecutiveBureau.hasMany(ExecutiveMember, { as: "sub_bureau_ExecutiveMembers", foreignKey: "sub_bureau"});
  ActivityFeedbackExecutive.belongsTo(ExecutiveMember, { as: "student", foreignKey: "student_id"});
  ExecutiveMember.hasMany(ActivityFeedbackExecutive, { as: "ActivityFeedbackExecutives", foreignKey: "student_id"});
  ExecutiveMember.belongsTo(ExecutiveType, { as: "type", foreignKey: "type_id"});
  ExecutiveType.hasMany(ExecutiveMember, { as: "ExecutiveMembers", foreignKey: "type_id"});
  FundingEvidence.belongsTo(Funding, { as: "funding", foreignKey: "funding_id"});
  Funding.hasMany(FundingEvidence, { as: "FundingEvidences", foreignKey: "funding_id"});
  FundingFeedback.belongsTo(Funding, { as: "funding_Funding", foreignKey: "funding"});
  Funding.hasMany(FundingFeedback, { as: "FundingFeedbacks", foreignKey: "funding"});
  FundingFixture.belongsTo(Funding, { as: "funding", foreignKey: "funding_id"});
  Funding.hasMany(FundingFixture, { as: "FundingFixtures", foreignKey: "funding_id"});
  FundingNoncorp.belongsTo(Funding, { as: "funding", foreignKey: "funding_id"});
  Funding.hasMany(FundingNoncorp, { as: "FundingNoncorps", foreignKey: "funding_id"});
  FundingTransportation.belongsTo(Funding, { as: "funding", foreignKey: "funding_id"});
  Funding.hasMany(FundingTransportation, { as: "FundingTransportations", foreignKey: "funding_id"});
  FundingTransportationMember.belongsTo(Funding, { as: "funding", foreignKey: "funding_id"});
  Funding.hasMany(FundingTransportationMember, { as: "FundingTransportationMembers", foreignKey: "funding_id"});
  FundingEvidence.belongsTo(FundingEvidenceType, { as: "funding_evidence_type", foreignKey: "funding_evidence_type_id"});
  FundingEvidenceType.hasMany(FundingEvidence, { as: "FundingEvidences", foreignKey: "funding_evidence_type_id"});
  Funding.belongsTo(FundingFeedbackType, { as: "funding_feedback_type_FundingFeedbackType", foreignKey: "funding_feedback_type"});
  FundingFeedbackType.hasMany(Funding, { as: "Fundings", foreignKey: "funding_feedback_type"});
  FundingFixture.belongsTo(FundingFixtureObjectType, { as: "fixture_type", foreignKey: "fixture_type_id"});
  FundingFixtureObjectType.hasMany(FundingFixture, { as: "FundingFixtures", foreignKey: "fixture_type_id"});
  FundingFixture.belongsTo(FundingFixtureType, { as: "funding_fixture_type", foreignKey: "funding_fixture_type_id"});
  FundingFixtureType.hasMany(FundingFixture, { as: "FundingFixtures", foreignKey: "funding_fixture_type_id"});
  FundingTransportation.belongsTo(FundingTransportationType, { as: "transportation_type", foreignKey: "transportation_type_id"});
  FundingTransportationType.hasMany(FundingTransportation, { as: "FundingTransportations", foreignKey: "transportation_type_id"});
  Meeting.belongsTo(MeetingType, { as: "type", foreignKey: "type_id"});
  MeetingType.hasMany(Meeting, { as: "Meetings", foreignKey: "type_id"});
  ActivityFeedback.belongsTo(Member, { as: "student", foreignKey: "student_id"});
  Member.hasMany(ActivityFeedback, { as: "ActivityFeedbacks", foreignKey: "student_id"});
  ...
  ActivityMember_init.belongsTo(Member, { as: "member_student", foreignKey: "member_student_id"});
  Member.hasMany(ActivityMember_init, { as: "ActivityMember_inits", foreignKey: "member_student_id"});
  ...
  Member.hasMany(ExecutiveMember, { as: "ExecutiveMembers", foreignKey: "student_id"});
  Funding.belongsTo(Member, { as: "funding_executive_Member", foreignKey: "funding_executive"});
  Member.hasMany(Funding, { as: "Fundings", foreignKey: "funding_executive"});
  FundingFeedback.belongsTo(Member, { as: "student", foreignKey: "student_id"});
  Member.hasMany(FundingFeedback, { as: "FundingFeedbacks", foreignKey: "student_id"});
  FundingTransportationMember.belongsTo(Member, { as: "student", foreignKey: "student_id"});
  Member.hasMany(FundingTransportationMember, { as: "FundingTransportationMembers", foreignKey: "student_id"});
  ...
  RegistrationActivityFeedback.belongsTo(Member, { as: "student", foreignKey: "student_id"});
  Member.hasMany(RegistrationActivityFeedback, { as: "RegistrationActivityFeedbacks", foreignKey: "student_id"});
  ...
  RegistrationActivity.hasMany(RegistrationActivityEvidence, { as: "RegistrationActivityEvidences", foreignKey: "activity_id"});
  RegistrationActivityFeedback.belongsTo(RegistrationActivity, { as: "activity_RegistrationActivity", foreignKey: "activity"});
  RegistrationActivity.hasMany(RegistrationActivityFeedback, { as: "RegistrationActivityFeedbacks", foreignKey: "activity"});
  RegistrationActivityMember.belongsTo(RegistrationActivity, { as: "activity", foreignKey: "activity_id"});
  ...
  Semester.hasMany(ActivitySign, { as: "ActivitySigns", foreignKey: "semester_id"});
