...
import "./AddClubRegistrationActivity.css";
...
function setTotalExpenditureMoney(totalExpenditureAmount: any) {
  throw new Error("Function not implemented.");
}

function setTotalApprovedMoney(totalApprovedAmount: any) {
  throw new Error("Function not implemented.");
}
